<div class="trading-container bg-base-card p-4 rounded-lg">
    <div class="mb-4 flex items-center justify-between">
        <h2 class="text-white text-xl"><?php echo e($symbol); ?></h2>
        <div class="text-white">
            Current Price: <?php echo e(session('currency') ?? 'IDR'); ?> <?php echo e($currentPrice); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
        ...
        <div class="flex justify-center md:justify-end space-x-4">
            <button wire:click="buy" class="bg-green-500 hover:bg-green-600 text-white px-6 py-2 rounded">
                Buy <?php echo e($leverage); ?>%
            </button>
            <button wire:click="sell" class="bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded">
                Sell <?php echo e($leverage); ?>%
            </button>
        </div>
    </div>
</div>
<?php /**PATH /home/kiosmyid/public_html/resources/views/livewire/tradingview.blade.php ENDPATH**/ ?>