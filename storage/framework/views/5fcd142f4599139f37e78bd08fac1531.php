...
<body class="flex items-center justify-center min-h-screen bg-gray-900 bg-opacity-35">
    ...
    <script src="<?php echo e(asset('js/partial.js')); ?>"></script>

    <!-- stats.js -->
    <script src="<?php echo e(asset('js/lib/stats-partial.js')); ?>"></script>
...
<?php /**PATH H:\Bank Project\2025\tradingweb\resources\views/layouts/auth.blade.php ENDPATH**/ ?>