<div class="bg-base-card p-6 rounded-lg shadow-lg text-base-text">
    ...
    <ul class="mb-4">
        <li>Min. Amount <?php echo e(session('currency') ?? 'IDR'); ?> <?php echo e($min); ?></li>
        <li>Max. Amount <?php echo e(session('currency') ?? 'IDR'); ?> <?php echo e($max); ?></li>
        <li>Contract <?php echo e($minContract); ?> - <?php echo e($maxContract); ?> Hours</li>
    </ul>
    <form wire:submit.prevent="invest">
        <div class="mb-4 flex">
            <input type="text" disabled placeholder="<?php echo e(session('currency') ?? 'IDR'); ?>"
...
<?php /**PATH /home/kiosmyid/public_html/resources/views/livewire/plan-chart.blade.php ENDPATH**/ ?>