...
<?php endif; ?>
    ...
    <div class="bg-base-card text-base-text mt-3">
        ...
        <div class="p-3">
            <p class="text-sm">Welcome to The Systematic Trade Member Panel.</p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\Bank Project\2025\tradingweb\resources\views/welcome.blade.php ENDPATH**/ ?>