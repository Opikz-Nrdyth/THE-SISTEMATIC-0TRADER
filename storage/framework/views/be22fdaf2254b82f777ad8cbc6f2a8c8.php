    ...
    <div class="bg-gray-800 bg-opacity-75 p-8 rounded-lg shadow-lg w-full max-w-md border-2 border-primary">
        <div class="text-center mb-6">
            <img alt="Logo of a wolf head with text 'The Systematic Trader'" class="mx-auto mb-4" height="100"
                src="<?php echo e(asset('images/logo.png')); ?>" width="100" />
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2579655745-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH H:\Bank Project\2025\tradingweb\resources\views/RegisterPanel.blade.php ENDPATH**/ ?>