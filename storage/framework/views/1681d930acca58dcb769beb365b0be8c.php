<div class="trading-container bg-base-card p-4 rounded-lg">
    <div class="mb-4 flex items-center justify-between">
        ...
        <div class="text-white">
            Current Price: <?php echo e(session('currency')); ?> <?php echo e($currentPrice); ?>
...
<?php /**PATH H:\Bank Project\2025\tradingweb\resources\views/livewire/tradingview.blade.php ENDPATH**/ ?>