<div class="mt-4">
    ...
    <div class="flex items-center border rounded-md bg-base-input text-white">
        ...
        <label for="<?php echo e($name); ?>"
            class="px-4 py-3 bg-primary text-white text-sm font-medium cursor-pointer rounded-r-md">
            Select File
        </label>
...
<?php /**PATH H:\Bank Project\2025\tradingweb\resources\views/components/input-image.blade.php ENDPATH**/ ?>