<div class="w-[20%] ml-0 bg-base-side text-white min-h-screen pb-3 transition-all duration-200 relative z-10"
    ...
    <div class="flex flex-col items-center py-8 border-b-2 gap-5 border-base-text">
        <p class="text-primary text-xl main-link"><b>Welcome</b> <?php echo e(auth()->user()->role ?? ''); ?></p>
        <div class="w-[50px] h-[50px] rounded-full bg-primary flex justify-center items-center">
            <img class="w-full h-full rounded-full"
                src="<?php if(auth()->user()->userData->profile_image ?? ''): ?> <?php echo e(asset('public/storage/' . auth()->user()->userData->profile_image)); ?>
        ...
        <div class="text-center text-base-text main-link">
            ...
            <p>(<?php echo e(auth()->user()->userData->username ?? ''); ?>)</p>
        </div>
    </div>
    ...
    <div class="text-base-text flex flex-col container-link">
        ...
        <div class="nav-group">
            <nav class="py-2 px-4 flex justify-between hover:text-white group border-l-2 <?php echo e($route == 'profile' || $route == 'profile-images' ? 'border-l-primary' : 'border-l-base-side'); ?>"
        ...
        <div class="nav-group">
            <nav class="py-2 px-4 flex justify-between hover:text-white group border-l-2 <?php echo e($route == 'trade' || $route == 'history' || $route == 'profits' ? 'border-l-primary' : 'border-l-base-side'); ?>"
        ...
        <!--<a href="/referals">-->
        <!--    <nav-->
        <!--        class="py-2 px-4 flex gap-5 items-center border-l-2 <?php echo e($route == 'referals' ? 'border-l-primary' : 'border-l-base-side'); ?> hover:text-white">-->
        <!--        <span class="w-[40px] h-[40px] flex justify-center items-center bg-base-button rounded-full">-->
...
<?php /**PATH /home/kiosmyid/public_html/resources/views/components/sidebar.blade.php ENDPATH**/ ?>