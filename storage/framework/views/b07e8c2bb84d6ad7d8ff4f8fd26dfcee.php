<header
    ...
    <nav class="flex items-center sm:gap-1 lg:gap-4 relative">
        <button class="bg-base-card p-2 rounded">
            <p><span wire:click="show_currency"><i class="fa-solid fa-caret-down"></i> <?php echo e($currency_selected); ?></span>
...
<?php /**PATH H:\Bank Project\2025\tradingweb\resources\views/livewire/header.blade.php ENDPATH**/ ?>