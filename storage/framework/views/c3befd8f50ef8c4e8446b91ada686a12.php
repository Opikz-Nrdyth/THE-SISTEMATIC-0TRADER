...
<?php $component = App\View\Components\Input::resolve(['model' => 'message','label' => 'Testimonials (max 350 chareacter)','name' => 'message','type' => 'text-area'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH /home/kiosmyid/public_html/resources/views/livewire/form-testimonial.blade.php ENDPATH**/ ?>