        ...
        return $table
            ->columns([
                ...
                TextColumn::make('user.name')
                    ...
                    ->searchable()
                    ->sortable(),
                ImageColumn::make('identity')->width(50)->url(fn($record) => asset('public/storage/' . $record->identity)),
                ImageColumn::make('photo')->width(50)->url(fn($record) => asset('public/storage/' . $record->photo)),
