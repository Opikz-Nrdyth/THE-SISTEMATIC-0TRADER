<form wire:submit.prevent="submit">
    ...
    <x-select model="currency_type" placeholder="Withdrawal Currency" name="currency"
        options="SGD (Singapure Dollar), IDR (Indonesia Rupiah)" />
    @error('currency_type')
    ...
    @error('user_bank')
        <span class="text-red-500">{{ $message }}</span>
    @enderror
    <x-input model="amount_withdaraw" label="Amount Withdrawal"
        placeholder="Amount Withdrawal" name="amount" />
